<?php
    ...
    class Ordenantza
    {
         ...
         * Add parrafoak
         *
         * @param \App\Entity\Ordenantzaparrafoa $parrafoak
         *
         * @return Ordenantza
         */
        public function addParrafoak(\App\Entity\Ordenantzaparrafoa $parrafoak)
        {
         ...
         * @param \App\Entity\Ordenantzaparrafoa $parrafoak
         */
        public function removeParrafoak(\App\Entity\Ordenantzaparrafoa $parrafoak)
        {
         ...
         * Add atalak
         *
         * @param \App\Entity\Atala $atalak
         *
         * @return Ordenantza
         */
        public function addAtalak(\App\Entity\Atala $atalak)
        {
            $this->atalak[] = $atalak;
         ...
         * @param \App\Entity\Atala $atalak
         */
        public function removeAtalak(\App\Entity\Atala $atalak)
        {
