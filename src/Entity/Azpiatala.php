<?php
    ...
    class Azpiatala
    {
         ...
         *
         * @param \App\Entity\Azpiatalaparrafoaondoren $parrafoakondoren
         *
         * @return Azpiatala
         */
        public function addParrafoakondoren(\App\Entity\Azpiatalaparrafoaondoren $parrafoakondoren)
        {
         ...
         * @param \App\Entity\Azpiatalaparrafoaondoren $parrafoakondoren
         */
        public function removeParrafoakondoren(\App\Entity\Azpiatalaparrafoaondoren $parrafoakondoren)
        {
